...
Download and install Ovito Basic: https://www.ovito.org/

You must have Python 3 with `pip` and `conda` installed on your system.

Open Terminal application. Check if you have Python 3 and conda:
```bash
python3 --version # should print the version number
python3 -m pip --version # should print the version number
conda --version # should print the version number
```
